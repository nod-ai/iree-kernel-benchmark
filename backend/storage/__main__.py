...
kernels = load_artifact_kernels(directory_client, f'{timestamp_str}/benchmark-results')
print(f'{timestamp_str}/benchmark-results')
# db_client.insert_run(BenchmarkRun(
